    ...
    <div className="space-y-6">
      ...
      {posts.length === 0 ? (
        <div className="bg-white rounded-2xl border border-black/[0.06] p-16 text-center">
          ...
          <Link href="/adoption/new" className="inline-flex items-center gap-2 bg-[#2D5016] text-white px-6 py-3 rounded-full font-medium hover:bg-[#4A7C28] transition-all">
            Post for Adoption
          </Link>
        </div>
      ) : (
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  {post.ownerId !== user.id ? (
                    ...
                    <span className="text-xs bg-green-100 text-green-700 px-3 py-1.5 rounded-full font-medium">Your Post</span>
                  )}
                </div>
              </div>
            </div>
